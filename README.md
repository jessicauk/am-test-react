...
Lo que más disfruté fue implementar toda la experiencia visual con personalizacion de efectos,  y trabajar con el diseño en general. También me gustó integrar Redux Toolkit para manejar el estado de la aplicación.
...
Hubiera agregado tal vez un paginador y una funcionalidad para ordenamiento de los personajes
Tambien un overlay y un evento que ocultara la lista de favoritos
